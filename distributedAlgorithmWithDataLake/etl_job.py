...
# 2. Write to HDFS as a Delta table (ACID-transactional, atomic overwrite)
hdfs_path = "hdfs://localhost:9000/user/demo/network_data"
oracle_df = oracle_df.repartition(4)
oracle_df.write.format("delta").mode("overwrite").save(hdfs_path)
